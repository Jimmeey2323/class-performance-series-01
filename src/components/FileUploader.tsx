  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center space-y-3">
        <h1 className="text-3xl font-bold tracking-tight">Class Analytics Data Processor</h1>
        ...
        {!selectedFile ? (
          <motion.div
            className={`
              ...
              ${isDragging 
                ? 'border-primary bg-primary/5 from-primary/5 to-transparent' 
                : 'border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 from-gray-50/50 to-transparent dark:from-gray-900/20'
              }
            `}
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              ...
              <div className="flex flex-col space-y-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">
                  Your file should contain a CSV with the pattern: "momence-teachers-payroll-report-aggregate-combined"
                </p>
              </div>
              ...
              <div className="space-y-4 w-full max-w-md">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    {uploadState === 'ready' ? (
                      <span className="text-xs bg-green-100 text-green-800 dark:bg-green-900/50 dark:text-green-300 px-2 py-1 rounded-full flex items-center">
                        <Check className="mr-1 h-3 w-3" />
                        Ready
                      </span>
                    ) : (
                      <span className="text-xs bg-red-100 text-red-800 dark:bg-red-900/50 dark:text-red-300 px-2 py-1 rounded-full flex items-center">
